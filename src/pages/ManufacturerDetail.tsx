    ...
    return (
      <Layout>
        <div className="text-center">
          <h1 className="text-2xl font-bold text-gray-900">Manufacturer Not Found</h1>
          <p className="mt-2 text-gray-600">The manufacturer you're looking for doesn't exist.</p>
