...
const FailureModeForm = () => {
  ...
  const initialFailureMode = isEditing ? {
    id: id,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      ...
      description: isEditing 
        ? `Failure mode ${formData.name} has been updated successfully` 
        : `Failure mode ${formData.name} has been created successfully`,
    });
        ...
        <Card>
          <form onSubmit={handleSubmit}>
            ...
            <CardFooter className="flex justify-between">
              <Button type="button" variant="outline" onClick={() => navigate('/failure-modes')}>
                Cancel
              </Button>
              <Button type="submit">
