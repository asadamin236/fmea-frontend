      ...
      <table className="border-2 border-black border-collapse min-w-[900px] text-xs font-sans select-none">
        <thead>
          ...
          <tr>
            <th
              rowSpan={7}
              colSpan={3}
              className="border border-black bg-gray-400 font-bold text-center align-middle w-14"
            >
              Impact
            </th>
          </tr>
          ...
          <tr>
          <th  colSpan={2} className="border border-black bg-gray-400 font-bold text-center max-w-[100px]">
              Consequence
            </th>{['1\nInsignificant', '2\nMinor', '3\nModerate', '4\nMajor', '5\nCatastrophic'].map((text, i) => (
              <th key={i} className="border border-black bg-gray-300 font-bold text-center whitespace-pre-line">
                {text}
              </th>
            ))}
          </tr>
          ...
          <tr>
            <th rowSpan={2}  className="border border-black bg-gray-400 font-bold text-center align-middle max-w-[100px]">
              Asset Damage
            </th>
        ...
        <tbody>
          ...
          <tr>
            <td
              rowSpan={6}
              className="border border-black bg-orange-200 font-bold text-center align-middle w-6"
              style={{ writingMode: 'vertical-lr', textOrientation: 'mixed' }}
            >
              Likelihood/requency
            </td>
            <td className="border border-black bg-orange-200 font-bold text-center">
              E<br />
              Almost Certain
            </td>
          ...
          <tr>
            ...
            <td colSpan={2} className="border border-black text-center max-w-[100px]">
              0.5 - 4 Years
            </td>
          ...
          <tr>
            ...
            <td className="border border-black bg-green-700 text-white font-bold text-center">A4</td>
